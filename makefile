...
eval_host_d.o: Path_CPU/eval_host.h Path_CPU/eval_host.cpp poly_d.o workspace_host_d.o DefineTypesDD/DefineType.h
	g++ -O2  -I./Poly -I./DefineTypesD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
...
utilities_d.o: Poly/utilities.h Poly/utilities.cpp
	g++ -O2  -I./DefineTypesD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/utilities.cpp -o utilities_d.o 

families_d.o: Poly/families.h Poly/families.cpp
	g++ -O2  -I./DefineTypesD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/families.cpp -o families_d.o

poly_d.o: Poly/poly.h Poly/poly.cpp utilities_d.o DefineTypesDD/DefineType.h
	g++ -O2  -I./DefineTypesD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/poly.cpp -o poly_d.o
	         
path_d.o: Path_CPU/path.cpp Path_CPU/parameter.h families_d.o path_host_d.o path_gpu_d.o newton_host_d.o
	g++ -O2  -I./Poly -I./DefineTypesD -I./Path_GPU -I./Path_CPU \
...
eval_host_dd.o: Path_CPU/eval_host.h Path_CPU/eval_host.cpp poly_dd.o workspace_host_dd.o DefineTypesDD/DefineType.h
	g++ -O2 -I./Poly -I./DefineTypesDD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
...
utilities_dd.o: Poly/utilities.h Poly/utilities.cpp
	g++ -O2  -I./DefineTypesDD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/utilities.cpp -o utilities_dd.o 

families_dd.o: Poly/families.h Poly/families.cpp
	g++ -O2  -I./DefineTypesDD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/families.cpp -o families_dd.o

poly_dd.o: Poly/poly.h Poly/poly.cpp utilities_dd.o DefineTypesDD/DefineType.h
	g++ -O2  -I./DefineTypesDD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/poly.cpp -o poly_dd.o
	         
path_dd.o: Path_CPU/path.cpp Path_CPU/parameter.h families_dd.o path_host_dd.o path_gpu_dd.o newton_host_dd.o
	g++ -O2  -I./DefineTypesDD -I./Path_GPU -I./Path_CPU -I./Poly \
            -I$(QD_ROOT)/include -I/usr/local/cuda/include \
...
eval_host_qd.o: Path_CPU/eval_host.h Path_CPU/eval_host.cpp poly_qd.o workspace_host_qd.o DefineTypesDD/DefineType.h
	g++ -O2 -I./Poly -I./DefineTypesQD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
...
utilities_qd.o: Poly/utilities.h Poly/utilities.cpp
	g++ -O2  -I./DefineTypesQD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/utilities.cpp -o utilities_qd.o 

families_qd.o: Poly/families.h Poly/families.cpp
	g++ -O2  -I./DefineTypesQD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/families.cpp -o families_qd.o

poly_qd.o: Poly/poly.h Poly/poly.cpp utilities_qd.o DefineTypesDD/DefineType.h
	g++ -O2  -I./DefineTypesQD -I$(QD_ROOT)/include -I/usr/local/cuda/include \
            -I$(GQD_HOME)/inc -c Poly/poly.cpp -o poly_qd.o
	         
path_qd.o: Path_CPU/path.cpp Path_CPU/parameter.h families_qd.o path_host_qd.o path_gpu_qd.o newton_host_qd.o
	g++ -O2  -I./Poly -I./DefineTypesQD -I./Path_GPU -I./Path_CPU \
            -I$(QD_ROOT)/include -I/usr/local/cuda/include \
