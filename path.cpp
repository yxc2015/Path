...
T1 err_check_workspace(const CT* workspace1, const CT* workspace2, int n_workspace_size);
   ...
   Returns 0 if okay, otherwise the function returns 1. */
{
	if(argc < 4){
		...
		cout << "Test  option: " << std::endl
		     ...
		     << "  4: Newton Test" << endl  \
		     << "  5: Path Tracking Test" << endl  \
		     << "  6: Path Tracking Reverse Test" << endl  \
		     << "  7: Witeness Set Test" << endl  \
		     << "  8: Pieri Test" << endl  \
		     << "  else: All Test" << endl;
